    ...
    return (
        <div className="flex justify-around items-center lg:flex-row flex-col-reverse">
            <div className="max-w-xl px-2 lg:px-0 ">
               ...
               <button className='px-3 py-2 bg-[#9333ea] drop-shadow-md  font-inter text-white   rounded cursor-pointer'>Report a Crime Now</button>
               <button className='px-3 py-2 bg-[#9333ea] drop-shadow-md font-inter text-white   rounded cursor-pointer'>Explore Crime Feed</button>
               </div>
            </div>
